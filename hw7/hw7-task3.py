...
нуля, иначе выводить соответствующее сообщение. Умножение. Создается общая клетка из двух. Число ячеек общей
...
class Cell:
    ...
    def __sub__(self, other):
        return self.quantity - other.quantity if (self.quantity - other.quantity) > 0 else print('Вычитание невозможно')
...
cells1 = Cell(45)
cells2 = Cell(9)
print(cells1.__add__(cells2))
print(cells1.__sub__(cells2))
print(cells2.__sub__(cells1))
print(cells1.__mul__(cells2))
print(cells1.__truediv__(cells2))
